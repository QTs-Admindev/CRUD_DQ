"""Async worker that syncs a bulk-imported sensor batch against the platform.
...
# Firmware version the platform expects on insert (same legacy default as create.py).
SENSOR_VERSION = "404"
